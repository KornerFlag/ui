# WEBSITE-DESIGN-RULES.md — Website Design Standards

This file governs how websites are built in this project. The goal is a site that looks
...
- **No emoji inside headings or section titles.** Use real iconography instead,
