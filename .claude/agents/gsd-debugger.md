...
<required_reading>
@C:/Korner flag/.claude/get-shit-done/references/common-bug-patterns.md
</required_reading>
...
@C:/Korner flag/.claude/get-shit-done/references/debugger-philosophy.md
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = C:/Korner flag/.claude
                  → checks C:/Korner flag/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = C:/Korner flag/.claude/get-shit-done
                  → writes to C:/Korner flag/.claude/get-shit-done/hooks/
...
@C:/Korner flag/.claude/get-shit-done/references/thinking-models-debug.md
...
- Read @C:/Korner flag/.claude/get-shit-done/references/common-bug-patterns.md
