...
Reference full template: `C:/Korner flag/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `C:/Korner flag/.claude/get-shit-done/templates/state.md`.
