...
<reference>
@C:/Korner flag/.claude/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `C:/Korner flag/.claude/get-shit-done/references/user-profiling.md` to load:
