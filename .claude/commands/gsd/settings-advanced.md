...
<execution_context>
@C:/Korner flag/.claude/get-shit-done/workflows/settings-advanced.md
</execution_context>

<process>
**Follow the settings-advanced workflow** from `@C:/Korner flag/.claude/get-shit-done/workflows/settings-advanced.md`.
