...
```
Task(
  prompt="Read C:/Korner flag/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `C:/Korner flag/.claude/get-shit-done/templates/VALIDATION.md`
