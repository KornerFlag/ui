...
<required_reading>
@C:/Korner flag/.claude/get-shit-done/references/ai-frameworks.md
@C:/Korner flag/.claude/get-shit-done/references/ai-evals.md
</required_reading>
...
```markdown
Read C:/Korner flag/.claude/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "C:/Korner flag/.claude/get-shit-done/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read C:/Korner flag/.claude/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read C:/Korner flag/.claude/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read C:/Korner flag/.claude/agents/gsd-eval-planner.md for instructions.
