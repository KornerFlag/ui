...
```markdown
Read C:/Korner flag/.claude/agents/gsd-ui-researcher.md for instructions.
...
Template: C:/Korner flag/.claude/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read C:/Korner flag/.claude/agents/gsd-ui-checker.md for instructions.
