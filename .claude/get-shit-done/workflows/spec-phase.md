...
```bash
INIT=$(node "C:/Korner flag/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @C:/Korner flag/.claude/get-shit-done/templates/spec.md.
