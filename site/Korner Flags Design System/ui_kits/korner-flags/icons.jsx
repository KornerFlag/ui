/* Korner Flags UI kit — Icon component.
   Inline SVG using Lucide (lucide.dev) path data for full control over
   size/stroke/color in React. Documented substitution: Lucide. */
(function () {
  const P = {
  ...
  function Icon({ name, size = 18, stroke = 2, className = "", style = {} }) {
    const inner = P[name] || P["circle-dot"];
    return React.createElement("svg", {
      className: "kf-ico " + className,
